...
export default function PublicLogin() {
  ...
  return (
    <PageLayout heroTitle="" heroSubtitle="" showHero={false}>
      <div className="min-h-[60vh] bg-slate-50 py-12 flex items-center justify-center px-4">
        <div className="w-full max-w-md bg-white rounded-2xl shadow-lg p-8 border border-slate-200">
          <h1 className="text-2xl font-bold text-blue-900 mb-2">เข้าสู่ระบบ</h1>
